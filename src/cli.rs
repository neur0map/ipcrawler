...
pub struct Cli {
    ...
    #[arg(
        ...
        long = "output",
        value_name = "PATH",
        help = "Output directory (default: ./ipcrawler_<target>_<timestamp>)"
    )]
    ...
    #[arg(
        ...
        help = "LLM provider: groq, openai, anthropic, ollama"
    )]
    ...
    #[arg(
        ...
        long = "ports",
        value_name = "PORTS",
        help = "Port specification (e.g., 22,80,443 or 1-1000). Default: top 1000 most common ports"
    )]
    ...
    #[arg(
        ...
        long = "wordlist",
        value_name = "NAME",
        help = "Wordlist name or path (e.g., common, medium, big, or /path/to/list.txt). Default: common"
    )]
...
impl Cli {
    pub fn validate(&self) -> anyhow::Result<()> {
        ...
        if self.consistency_passes == 0 || self.consistency_passes > 5 {
            anyhow::bail!(
                "Consistency passes must be between 1 and 5 (got: {})",
                self.consistency_passes
            );
        }
