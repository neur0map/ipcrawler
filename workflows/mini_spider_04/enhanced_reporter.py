...
class EnhancedReporter:
    ...
    def _generate_text_report(self, spider_result: MiniSpiderResult, output_dir: Path) -> Path:
        ...
        with open(txt_file, 'w', encoding='utf-8') as f:
            ...
            if hasattr(spider_result, 'enhanced_analysis') and spider_result.enhanced_analysis and not spider_result.enhanced_analysis.get('error'):
            ...
            # URL categories
            if spider_result.categorized_results:
